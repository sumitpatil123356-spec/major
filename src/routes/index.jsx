  ...
  head: () => ({
    meta: [
      { title: "ReShelf — Nothing useful should go to waste." },
      {
        name: "description",
        content:
          "Track products, receive expiry alerts, and donate surplus before it becomes waste. Built for households, restaurants, pharmacies and communities.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Track products, receive expiry alerts, and donate surplus before it becomes waste — for
            households, restaurants, pharmacies and communities.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Button
              asChild
              size="lg"
              className="brand-gradient text-white hover:opacity-90 shadow-[var(--shadow-glow)]"
            >
          ...
          {[
            {
              n: "01",
              t: "Add your products",
              d: "Log items by hand or scan receipts. Categorize as food, medicine, cosmetics or household.",
            },
            {
              n: "02",
              t: "Get smart alerts",
              d: "We watch the calendar so you don't have to. Warnings 30, 7 and 1 day before expiry.",
            },
            {
              n: "03",
              t: "Share the surplus",
              d: "Match with verified NGOs and community kitchens nearby. Schedule a pickup in a tap.",
            },
          ].map((s) => (
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                i: Bell,
                t: "Smart expiry alerts",
                d: "Tiered warnings at 30, 7 and 1 day with priority routing.",
              },
              {
                i: HandHeart,
                t: "Rescue Hub",
                d: "A live marketplace of donatable items with one-tap requests.",
              },
              {
                i: Building2,
                t: "NGO directory",
                d: "Verified partners with pickup windows and category fit.",
              },
              {
                i: BarChart3,
                t: "Impact analytics",
                d: "Track waste prevented, money saved and donations completed.",
              },
              {
                i: ShieldCheck,
                t: "Role-based access",
                d: "Tailored flows for households, businesses, NGOs and admins.",
              },
              {
                i: Sparkles,
                t: "AI roadmap",
                d: "Receipt scanning, expiry prediction and smart donation matching.",
              },
            ].map((f) => (
      ...
      <section className="bg-[var(--gradient-soft)] border-y border-border/60">
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              {
                q: "We cut weekly waste by 38% in our first month. The alerts are honestly life-changing.",
                n: "Priya Menon",
                r: "Owner, Sunrise Cafe",
              },
              {
                q: "ReShelf made our donation workflow ridiculously simple. The NGO matching is brilliant.",
                n: "Arjun Rao",
                r: "Manager, GreenMart",
              },
              {
                q: "Our pharmacy now redirects soon-to-expire stock to clinics — zero loss, real impact.",
                n: "Dr. Neha Iyer",
                r: "MediCare Pharmacy",
              },
            ].map((t) => (
          ...
          {[
            {
              p: "Free",
              price: "₹0",
              desc: "For households starting out.",
              f: ["Up to 50 products", "Smart expiry alerts", "NGO directory access"],
            },
            {
              p: "Business",
              price: "₹999",
              desc: "Restaurants & grocery stores.",
              f: ["Unlimited products", "Bulk upload", "Pickup scheduling", "Analytics dashboard"],
              featured: true,
            },
            {
              p: "Enterprise",
              price: "Custom",
              desc: "Chains, pharma & NGOs.",
              f: ["SSO & role management", "API access", "Dedicated success", "Custom reporting"],
            },
          ].map((tier) => (
            <Card
              key={tier.p}
              className={`border-border/60 ${tier.featured ? "ring-2 ring-primary shadow-[var(--shadow-glow)]" : ""}`}
            >
              <CardContent className="p-8">
                {tier.featured && (
                ...
                <Button
                  asChild
                  className={`mt-7 w-full ${tier.featured ? "brand-gradient text-white hover:opacity-90" : ""}`}
      ...
      <section id="faq" className="mx-auto max-w-3xl px-6 py-20">
        ...
        <Accordion type="single" collapsible className="mt-10">
          {[
            {
              q: "How does ReShelf know when something is expiring?",
              a: "You log purchase + expiry dates manually or via receipt import. We notify you 30, 7 and 1 day before expiry.",
            },
            {
              q: "Which NGOs do you work with?",
              a: "We partner with verified food banks, community kitchens and care foundations across major cities — and we keep adding more.",
            },
            {
              q: "Can businesses bulk-upload inventory?",
              a: "Yes. Business and Enterprise plans support CSV upload, inventory sync and scheduled donation pickups.",
            },
            {
              q: "Is ReShelf free for households?",
              a: "Yes — the Free tier covers up to 50 active products with all core features.",
            },
          ].map((f, i) => (
        ...
        <Card className="overflow-hidden border-0 brand-gradient text-white shadow-[var(--shadow-glow)]">
          <CardContent className="p-12 md:p-16 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-white/85">
              Join thousands of households and businesses redirecting surplus to those who need it.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 grid md:grid-cols-4 gap-8 text-sm">
          <div>
            ...
            <p className="mt-3 text-muted-foreground text-xs leading-relaxed">
              Track Expiry. Share Surplus. Reduce Waste.
            </p>
          </div>
          {[
