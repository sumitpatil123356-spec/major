        ...
        <Card className="lg:col-span-2 border-border/60">
          ...
          <CardContent>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <Label>Phone</Label>
                <Input defaultValue="+91 98000 11223" />
              </div>
              <div className="space-y-1.5">
                <Label>City</Label>
        ...
        <Card className="border-border/60">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input defaultValue="Helping Hands" />
            </div>
            <div className="space-y-1.5">
              <Label>Pickup window</Label>
              <Input defaultValue="Weekends, 10am – 2pm" />
            </div>
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium">Auto-list expiring items</div>
                <div className="text-xs text-muted-foreground">Add to Rescue Hub at T-7 days</div>
              </div>
