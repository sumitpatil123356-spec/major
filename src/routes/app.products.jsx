      ...
      <Dialog open={!!editingProduct} onOpenChange={(o) => !o && setEditingProduct(null)}>
        {editingProduct && (
          <EditProductDialog
            ...
            onSave={(updates) => handleEdit(editingProduct.id, updates)}
          />
        )}
      </Dialog>
    </AppShell>
    ...
    <DialogContent>
      ...
      >
        ...
        <div className="col-span-2 flex items-center gap-2 pt-2">
          ...
          <Label htmlFor="donatable" className="cursor-pointer text-sm font-medium">
            List on Rescue Hub (Available for donation)
          </Label>
        </div>
        <div className="col-span-2 space-y-1.5">
          <Label>Notes</Label>
        ...
        <DialogFooter className="col-span-2">
          <Button type="submit" className="brand-gradient text-white hover:opacity-90">
            Save product
          </Button>
        </DialogFooter>
      </form>
    ...
    <DialogContent>
      ...
      >
        ...
        <div className="col-span-2 flex items-center gap-2 pt-2">
          ...
          <Label htmlFor="edit-donatable" className="cursor-pointer text-sm font-medium">
            List on Rescue Hub (Available for donation)
          </Label>
        </div>
        <div className="col-span-2 space-y-1.5">
